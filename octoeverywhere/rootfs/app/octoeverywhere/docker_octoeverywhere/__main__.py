...
if __name__ == '__main__':
    ...
    try:
        ...
        ####### EDITED PART #######
        companionInstanceIdStr = os.environ.get("PRINTER_ID", None)
        serviceName = os.environ.get("SERVICE_NAME", "octoeverywhere")

        # Build the launch string
        launchConfig = {
            "ServiceName" : serviceName,
            "CompanionInstanceIdStr" : companionInstanceIdStr,
